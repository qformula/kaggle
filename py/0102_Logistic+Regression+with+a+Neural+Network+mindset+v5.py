...
#print("+++++++++++++++++++++++++++++++++++++")
#print(str(train_set_x_orig[2][1]))
...
def propagate(w, b, X, Y):
    ...
    #print("A: "+str(A))
    Log1 = np.log(A)    
    Log_part1 = np.dot(Y,Log1.T)
    #print("Log_part1"+ str(Log_part1))
    Log2 = np.log(1-A)
    Log_part2 = np.dot((1-Y),Log2.T)
    #print("Log_part2"+ str(Log_part2))
    J_part1 = np.sum(Log_part1+Log_part2,axis=1)
    J=(-1/m)*J_part1    
    #print("J_cost="+str(J))
    cost = J                            # compute cost    
    ### END CODE HERE ###
...
def optimize(w, b, X, Y, num_iterations, learning_rate, print_cost = False):
    ...
    for i in range(num_iterations):
        ...
        #if i % 25 == 0:  print ("==== w at iteration i="+str(i)+"  "+str(w))
...
my_image = "Louye_01.jpg"   # change this to the name of your image file 
## END CODE HERE ##
